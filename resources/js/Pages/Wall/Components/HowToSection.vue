    ...
    >
        ...
        >
            ...
            <div class="flex flex-col place-items-center mx-auto">
                ...
                <h1 class="w-full">
                    Vyber si zo stoviek textových veršov alebo si vytvor svoj.
                </h1>
            </div>
            <div class="flex flex-col place-items-center mx-auto">
                <div class="p-8 rounded-full bg-cyan-400 mb-6">
                ...
                <h1>
                    Vyber si doplnky ku pošte ako QR kód na video, voňavý papier
                    a unikátne darčeky.
                </h1>
            </div>
            <div class="flex flex-col place-items-center mx-auto">
                ...
                <h1>
                    Vyplň adresné údaje a objednaj, o zvyšok sa postaráme my.
                </h1>
            </div>
        </div>
    </div>
