<template>
    ...
    >
        ...
        <div
            class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 my-10 h-full place-items-center gap-8"
        >
            <div class="mx-10 flex flex-col place-items-center gap-4">
                <img
                    class="rounded-3xl hover:scale-105 duration-150 border-4"
            ...
            <div class="mx-10 flex flex-col place-items-center gap-4">
                <img
                    class="rounded-3xl hover:scale-105 duration-150 border-4"
                    src="../../../images/Posters/birthday4.jpeg"
                    alt=""
                />
                <h2>Narodeniny</h2>
            </div>
            <div class="mx-10 flex flex-col place-items-center gap-4">
                <img
                    class="rounded-3xl hover:scale-105 duration-150 border-4"
                    src="../../../images/Posters/birthday7.jpeg"
                    alt=""
                />
                <h2>Narodeniny</h2>
            </div>
            <div class="mx-10 flex flex-col place-items-center gap-4">
                <img
                    class="rounded-3xl hover:scale-105 duration-150 border-4"
                    src="../../../images/Posters/valentines2.jpeg"
                    alt=""
                />
                <h2>Valentín</h2>
            </div>
