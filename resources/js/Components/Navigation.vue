<template>
    <div class="specify-font relative z-50 w-full px-6 py-2 shadow-lg bg-cyan-100 shadow-black flex flex-row justify-between place-items-center">
        ...
        <div @click="toggleMenu" class="flex justify-end lg:hidden cursor-pointer">
            <MenuIcon/>
        </div>
        <div class="hidden lg:flex flex-row justify-between place-items-center">
            <div class="flex place-items-center gap-2 pr-8">
                <Link class=" border-2 border-transparent px-3 py-1 hover:bg-cyan-200 duration-150  hover:border-cyan-300 rounded-md" :href="route('wall')">Úvod</Link>
                <Link class=" border-2 border-transparent px-3 py-1 hover:bg-cyan-200 duration-150  hover:border-cyan-300 rounded-md"  :href="route('gallery')">Galéria</Link>
                <Link class=" border-2 border-transparent px-3 py-1 hover:bg-cyan-200 duration-150  hover:border-cyan-300 rounded-md"  :href="route('blog')">Blog</Link>
        ...
        <div v-if="showMenu" class="absolute top-16 bg-cyan-100 right-0 flex flex-col px-2 py-4 shadow-lg shadow-black">
            <div class="flex flex-col place-items-center pb-4 gap-2">
                <Link class=" border-2 border-transparent px-3 py-1 hover:bg-cyan-200 duration-150  hover:border-cyan-300 rounded-md" :href="route('wall')">Úvod</Link>
                <Link class=" border-2 border-transparent px-3 py-1 hover:bg-cyan-200 duration-150  hover:border-cyan-300 rounded-md"  :href="route('gallery')">Galéria</Link>
                <Link class=" border-2 border-transparent px-3 py-1 hover:bg-cyan-200 duration-150  hover:border-cyan-300 rounded-md"  :href="route('blog')">Blog</Link>
                <Link class=" border-2 border-transparent px-3 py-1 hover:bg-cyan-200 duration-150  hover:border-cyan-300 rounded-md"  :href="route('gift')">Darčeky</Link>
                <Link class="py-1 px-3 bg-[#ff948f] rounded-md text-white hover:bg-[#f9675f] duration-100" href="">Vytvoriť poštu</Link>
            </div>
            <div class="flex flex-col place-items-center gap-2 pt-2 border-t-2 border-black/20">
                <Link class=" border-2 border-transparent px-3 py-1 hover:bg-cyan-200 duration-150  hover:border-cyan-300 rounded-md"  :href="route('login')">Prihlásenie</Link>
                <Link class="py-1 px-3 bg-[#ff948f] rounded-md text-white hover:bg-[#f9675f] duration-100" :href="route('register')">Registrácia</Link>
            </div>
        </div>
    </div>
</template>
