...
Route::get('/blog/blog', \App\Http\Controllers\DetailBlogController::class)->name('blog.detail');
...
Route::get('/create', [\App\Http\Controllers\CreatePostController::class, 'create'])->name('create.post');
